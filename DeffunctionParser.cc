...
static bool ValidDeffunctionName(const Environment::Ptr&, const char *);
static Deffunction *AddDeffunction(const Environment::Ptr&, CLIPSLexeme *, Expression *, unsigned short, unsigned short, unsigned short, bool);
