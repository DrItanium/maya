...
static bool ParseDefinstances(const Environment::Ptr&, const char *);
static CLIPSLexeme *ParseDefinstancesName(const Environment::Ptr&, const char *, bool *);
static void RemoveDefinstances(const Environment::Ptr&, Definstances *);
static void SaveDefinstances(const Environment::Ptr&, Defmodule *, const char *, void *);

static void *AllocateModule(const Environment::Ptr&);
static void ReturnModule(const Environment::Ptr&, void *);
static bool ClearDefinstancesReady(const Environment::Ptr&, void *);
static void CheckDefinstancesBusy(const Environment::Ptr&, ConstructHeader *, void *);
static void DestroyDefinstancesAction(const Environment::Ptr&, ConstructHeader *, void *);

static void ResetDefinstances(const Environment::Ptr&, void *);
static void ResetDefinstancesAction(const Environment::Ptr&, ConstructHeader *, void *);
static void DeallocateDefinstancesData(const Environment::Ptr&);
...
bool DefinstancesIsDeletable(
        Definstances *theDefinstances) {
    const Environment::Ptr&theEnv = theDefinstances->header.env;
