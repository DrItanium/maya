...
static Instance *FindImportedInstance(const Environment::Ptr&, Defmodule *, Defmodule *, Instance *);

static void NetworkModifyForSharedSlot(const Environment::Ptr&, int, Defclass *, SlotDescriptor *);
