...
void FieldConversion(Environment *, lhsParseNode *, lhsParseNode *, nandFrame *);
expr *GetvarReplace(Environment *, lhsParseNode *, bool, nandFrame *);
void AddNandUnification(Environment *, lhsParseNode *, nandFrame *);
