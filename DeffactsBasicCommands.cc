...
static void ResetDeffacts(const Environment::Ptr&, void *);
static void SaveDeffacts(const Environment::Ptr&, Defmodule *, const char *, void *);
static void ResetDeffactsAction(const Environment::Ptr&, ConstructHeader *, void *);
...
void DeffactsBasicCommands(
    ...
    AddUDF(theEnv, "get-deffacts-list", "m", 0, 1, "y", GetDeffactsListFunction);
    AddUDF(theEnv, "undeffacts", "v", 1, 1, "y", UndeffactsCommand);
    AddUDF(theEnv, "deffacts-module", "y", 1, 1, "y", DeffactsModuleFunction);

#if DEBUGGING_FUNCTIONS
    AddUDF(theEnv, "list-deffacts", "v", 0, 1, "y", ListDeffactsCommand);
    AddUDF(theEnv, "ppdeffacts", "vs", 1, 2, ";y;ldsyn", PPDeffactsCommand);
#endif
...
#pragma unused(buffer)
    ...
    if (theDeffacts->assertList == nullptr) return;
...
bool Undeffacts(
    ...
    if (theDeffacts == nullptr) {
        theEnv = allEnv;
        return Undefconstruct(theEnv, nullptr, DeffactsData(theEnv)->DeffactsConstruct);
    } else {
