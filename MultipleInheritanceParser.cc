...
static PARTIAL_ORDER *InitializePartialOrderTable(const Environment::Ptr&, PARTIAL_ORDER *, PACKED_CLASS_LINKS *);
static void RecordPartialOrders(const Environment::Ptr&, PARTIAL_ORDER *, Defclass *,
                                PACKED_CLASS_LINKS *, unsigned long);
static PARTIAL_ORDER *FindPartialOrder(PARTIAL_ORDER *, Defclass *);
static void PrintPartialOrderLoop(const Environment::Ptr&, PARTIAL_ORDER *);
static void PrintClassLinks(const Environment::Ptr&, const char *, const char *, CLASS_LINK *);
