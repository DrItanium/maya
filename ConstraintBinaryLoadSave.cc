...
#if BLOAD_AND_BSAVE
static void CopyToBsaveConstraintRecord(const Environment::Ptr&, CONSTRAINT_RECORD *, BSAVE_CONSTRAINT_RECORD *);
#endif
static void CopyFromBsaveConstraintRecord(const Environment::Ptr&, void *, unsigned long);
