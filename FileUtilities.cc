...
static bool QueryDribbleCallback(const Environment::Ptr&, const char *, void *);
static int ReadDribbleCallback(const Environment::Ptr&, const char *, void *);
static int UnreadDribbleCallback(const Environment::Ptr&, const char *, int, void *);
static void ExitDribbleCallback(const Environment::Ptr&, int, void *);
static void WriteDribbleCallback(const Environment::Ptr&, const char *, const char *, void *);
static void PutcDribbleBuffer(const Environment::Ptr&, int);
#endif
static bool QueryBatchCallback(const Environment::Ptr&, const char *, void *);
static int ReadBatchCallback(const Environment::Ptr&, const char *, void *);
static int UnreadBatchCallback(const Environment::Ptr&, const char *, int, void *);
static void ExitBatchCallback(const Environment::Ptr&, int, void *);
static void AddBatch(const Environment::Ptr&, bool, FILE *, const char *, int, const char *, const char *);
