...
void Retain(const Environment::Ptr&, TypeHeader *);
void Release(const Environment::Ptr&, TypeHeader *);
void RetainCV(const Environment::Ptr&, CLIPSValue *);
void ReleaseCV(const Environment::Ptr&, CLIPSValue *);
void RetainUDFV(const Environment::Ptr&, UDFValue *);
