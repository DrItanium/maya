...
static void CreateSystemHandlers(const Environment::Ptr&, void *);

static bool WildDeleteHandler(const Environment::Ptr&, Defclass *, CLIPSLexeme *, const char *);

#if DEBUGGING_FUNCTIONS
static bool DefmessageHandlerWatchAccess(const Environment::Ptr&, int, bool, Expression *);
static bool DefmessageHandlerWatchPrint(const Environment::Ptr&, const char *, int, Expression *);
static bool DefmessageHandlerWatchSupport(const Environment::Ptr&, const char *, const char *, bool,
                                          void (*)(const Environment::Ptr&, const char *, Defclass *, unsigned),
                                          void (*)(Defclass *, unsigned, bool),
                                          Expression *);
static bool WatchClassHandlers(const Environment::Ptr&, Defclass *, const char *, int, const char *, bool, bool,
                               void (*)(const Environment::Ptr&, const char *, Defclass *, unsigned),
                               void (*)(Defclass *, unsigned, bool));
static void PrintHandlerWatchFlag(const Environment::Ptr&, const char *, Defclass *, unsigned);
#endif

static void DeallocateMessageHandlerData(const Environment::Ptr&);
...
void SetupMessageHandlers(
    ...
    MessageHandlerData(theEnv)->HandlerGetInfo = handlerGetInfo;
    MessageHandlerData(theEnv)->HandlerPutInfo = handlerPutInfo;
...
static bool DefmessageHandlerWatchSupport(
        ...
        const char *logName,
        bool newState,
        void (*printFunc)(const Environment::Ptr&, const char *, Defclass *, unsigned),
