...
void ExtendedMathFunctionDefinitions(
        Environment *theEnv) {
    AddUDF(theEnv, "cos", "d", 1, 1, "ld", CosFunction, nullptr);
    AddUDF(theEnv, "sin", "d", 1, 1, "ld", SinFunction, nullptr);
    AddUDF(theEnv, "tan", "d", 1, 1, "ld", TanFunction, nullptr);
    AddUDF(theEnv, "sec", "d", 1, 1, "ld", SecFunction, nullptr);
    AddUDF(theEnv, "csc", "d", 1, 1, "ld", CscFunction, nullptr);
    AddUDF(theEnv, "cot", "d", 1, 1, "ld", CotFunction, nullptr);
    AddUDF(theEnv, "acos", "d", 1, 1, "ld", AcosFunction, nullptr);
    AddUDF(theEnv, "asin", "d", 1, 1, "ld", AsinFunction, nullptr);
    AddUDF(theEnv, "atan", "d", 1, 1, "ld", AtanFunction, nullptr);
    AddUDF(theEnv, "atan2", "d", 2, 2, "ld", Atan2Function, nullptr);
    AddUDF(theEnv, "asec", "d", 1, 1, "ld", AsecFunction, nullptr);
    AddUDF(theEnv, "acsc", "d", 1, 1, "ld", AcscFunction, nullptr);
    AddUDF(theEnv, "acot", "d", 1, 1, "ld", AcotFunction, nullptr);
    AddUDF(theEnv, "cosh", "d", 1, 1, "ld", CoshFunction, nullptr);
    AddUDF(theEnv, "sinh", "d", 1, 1, "ld", SinhFunction, nullptr);
    AddUDF(theEnv, "tanh", "d", 1, 1, "ld", TanhFunction, nullptr);
    AddUDF(theEnv, "sech", "d", 1, 1, "ld", SechFunction, nullptr);
    AddUDF(theEnv, "csch", "d", 1, 1, "ld", CschFunction, nullptr);
    AddUDF(theEnv, "coth", "d", 1, 1, "ld", CothFunction, nullptr);
    AddUDF(theEnv, "acosh", "d", 1, 1, "ld", AcoshFunction, nullptr);
    AddUDF(theEnv, "asinh", "d", 1, 1, "ld", AsinhFunction, nullptr);
    AddUDF(theEnv, "atanh", "d", 1, 1, "ld", AtanhFunction, nullptr);
    AddUDF(theEnv, "asech", "d", 1, 1, "ld", AsechFunction, nullptr);
    AddUDF(theEnv, "acsch", "d", 1, 1, "ld", AcschFunction, nullptr);
    AddUDF(theEnv, "acoth", "d", 1, 1, "ld", AcothFunction, nullptr);

    AddUDF(theEnv, "mod", "ld", 2, 2, "ld", ModFunction, nullptr);
    AddUDF(theEnv, "exp", "d", 1, 1, "ld", ExpFunction, nullptr);
    AddUDF(theEnv, "log", "d", 1, 1, "ld", LogFunction, nullptr);
    AddUDF(theEnv, "log10", "d", 1, 1, "ld", Log10Function, nullptr);
    AddUDF(theEnv, "sqrt", "d", 1, 1, "ld", SqrtFunction, nullptr);
    AddUDF(theEnv, "pi", "d", 0, 0, nullptr, PiFunction, nullptr);
    AddUDF(theEnv, "deg-rad", "d", 1, 1, "ld", DegRadFunction, nullptr);
    AddUDF(theEnv, "rad-deg", "d", 1, 1, "ld", RadDegFunction, nullptr);
    AddUDF(theEnv, "deg-grad", "d", 1, 1, "ld", DegGradFunction, nullptr);
    AddUDF(theEnv, "grad-deg", "d", 1, 1, "ld", GradDegFunction, nullptr);
    AddUDF(theEnv, "**", "d", 2, 2, "ld", PowFunction, nullptr);
    AddUDF(theEnv, "round", "l", 1, 1, "ld", RoundFunction, nullptr);
}
