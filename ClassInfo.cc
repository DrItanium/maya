...
static SlotDescriptor *SlotInfoSlot(const Environment::Ptr&, UDFValue *, Defclass *, const char *, const char *);
...
bool SlotRange(
    ...
    if ((sp->constraint == nullptr) ? false :
        ...
        returnValue->multifieldValue->contents[0].value = sp->constraint->getMinValue()->value;
