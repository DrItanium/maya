...
void SetupInstances(const Environment::Ptr&);
UnmakeInstanceError DeleteInstance(Instance *);
UnmakeInstanceError DeleteAllInstances(const Environment::Ptr&);
UnmakeInstanceError UnmakeInstance(Instance *);
bool UnmakeInstanceCallback(Instance *, const Environment::Ptr&);
UnmakeInstanceError UnmakeAllInstances(const Environment::Ptr&);
#if DEBUGGING_FUNCTIONS
void InstancesCommand(const Environment::Ptr&theEnv, UDFContext *context, UDFValue *ret);
void PPInstanceCommand(const Environment::Ptr&theEnv, UDFContext *context, UDFValue *ret);
void Instances(const Environment::Ptr&, const char *, Defmodule *, const char *, bool);
#endif
Instance *MakeInstance(const Environment::Ptr&, const char *);
MakeInstanceError GetMakeInstanceError(const Environment::Ptr&);
Instance *CreateRawInstance(const Environment::Ptr&, Defclass *, const char *);
Instance *FindInstance(const Environment::Ptr&, Defmodule *, const char *, bool);
...
unsigned long GetGlobalNumberOfInstances(const Environment::Ptr&);
Instance *GetNextInstance(const Environment::Ptr&, Instance *);
Instance *GetNextInstanceInScope(const Environment::Ptr&, Instance *);
...
void ClassCommand(const Environment::Ptr&theEnv, UDFContext *context, UDFValue *ret);
void DeleteInstanceCommand(const Environment::Ptr&theEnv, UDFContext *context, UDFValue *ret);
void UnmakeInstanceCommand(const Environment::Ptr&theEnv, UDFContext *context, UDFValue *ret);
void SymbolToInstanceNameFunction(const Environment::Ptr&theEnv, UDFContext *context, UDFValue *ret);
void InstanceNameToSymbolFunction(const Environment::Ptr&theEnv, UDFContext *context, UDFValue *ret);
void InstanceAddressCommand(const Environment::Ptr&theEnv, UDFContext *context, UDFValue *ret);
void InstanceNameCommand(const Environment::Ptr&theEnv, UDFContext *context, UDFValue *ret);
void InstanceAddressPCommand(const Environment::Ptr&theEnv, UDFContext *context, UDFValue *ret);
void InstanceNamePCommand(const Environment::Ptr&theEnv, UDFContext *context, UDFValue *ret);
void InstancePCommand(const Environment::Ptr&theEnv, UDFContext *context, UDFValue *ret);
void InstanceExistPCommand(const Environment::Ptr&theEnv, UDFContext *context, UDFValue *ret);
void CreateInstanceHandler(const Environment::Ptr&theEnv, UDFContext *context, UDFValue *ret);
